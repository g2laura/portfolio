...
jQuery(window).load(function() {
    if (jQuery('body').find('.shopheader').length < 1) {
        $('.mukam-waypoint').css('marginTop', $('.mukam-header').outerHeight(
            true));
    }
});
...
jQuery('.mukam-waypoint2').each(function(i) {
    ...
    $el.waypoint(function(direction) {
        if (direction === 'down' && animClassDown) {
            $head2.attr('class', 'mukam-header2 ' +
                animClassDown);
        } else if (direction === 'up' && animClassUp) {
...
jQuery(document).ready(function() {
    jQuery('.top-section-container .showhide .trans-topsection').click(
        function() {
            jQuery('.top-section').slideToggle(300, "easeInSine",
                function() {
                    $('.mukam-waypoint').css('marginTop', $(
                        '.mukam-header').outerHeight(
                        true));
                    // Animation complete.
                });
        });
...
jQuery(document).ready(function() {
    ...
    jQuery(".search-widget .social-box").click(function() {
        if ($searchCheck == "close") {
            ...
            jQuery('.search-widget .social-box').addClass(
                'open');
            $searchCheck = "open"
        } else {
            jQuery('.search-widget').removeClass('open');
            jQuery('.search').removeClass('open');
            jQuery('.search-widget .social-box').removeClass(
                'open');
            $searchCheck = "close"
        }
    });
...
if (jQuery('body').find('.homepage-slider').length > 0) {
    jQuery(".homepage-slider p").fitText(1.8, {
        maxFontSize: '88px'
    });
}
...
if (jQuery('body').find('.latest-work-grid').length > 0) {
    jQuery(function(jQuery) {
        ...
        jQuery('.latest-word-grid-container .menu-widget a').click(
            function(e) {
                ...
                container.find('.latest-work-item').removeClass(
                    'hidden');
                container.find('.latest-work-item:not(.' + category +
                    ')').addClass('hidden');
...
jQuery(document).ready(function() {
    ...
    jQuery('.blind').waypoint(function() {
        ...
        if (ekclass[0] !== "no_animation" && myclass[1] ===
            "blind") {
...
jQuery(document).ready(function() {
    ...
    function findMaxYLValue() {
        ...
        $maxValueEl.one(
            ...
            function(e) {
                var transitionDelayValue = $maxValueEl.css(
                    "transition-delay");
                transitionDelay = Math.ceil(parseFloat(
                    transitionDelayValue.substring(0,
                        transitionDelayValue.length - 1) *
                    1000) * 1) / 1;
            });
    }
    findMaxYLValue();
...
function loaded() {
    ...
    localizeHTMLTag("english");
    localizeHTMLTag("spanish");
    localizeHTMLTag("banner1");
    localizeHTMLTag("banner2");
    localizeHTMLTag("banner3");
    localizeHTMLTag("banner4");
    localizeHTMLTag("banner5");
    localizeHTMLTag("banner6");
    localizeHTMLTag("banner7");
    localizeHTMLTag("service1.1");
    localizeHTMLTag("service1.2");
    localizeHTMLTag("service2.1");
    localizeHTMLTag("service2.2");
    localizeHTMLTag("service3.1");
    localizeHTMLTag("service3.2");
    localizeHTMLTag("service4.1");
    localizeHTMLTag("service4.2");
    localizeHTMLTag("tech1");
    localizeHTMLTag("tech2");
    localizeHTMLTag("work");
    localizeHTMLTag("desc");
    localizeHTMLTag("desc1");
    localizeHTMLTag("desc2");
    localizeHTMLTag("desc3");
    localizeHTMLTag("desc4");
    localizeHTMLTag("desc5");
    localizeHTMLTag("desc6");
    localizeHTMLTag("desc7");
    localizeHTMLTag("desc8");
    localizeHTMLTag("slide1");
    localizeHTMLTag("slide2");
    localizeHTMLTag("slide3");
    localizeHTMLTag("slide4");
    localizeHTMLTag("slide5");
    localizeHTMLTag("slide6");
    localizeHTMLTag("touch");
    localizeHTMLTag("converse");
    localizeHTMLTag("andresmoreno");
}
